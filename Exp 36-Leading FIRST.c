...
Enter productions Number 1 : S=AB
Enter productions Number 2 : A=Ca
Enter productions Number 3 : B=BaAC/c
Enter productions Number 4 : C=B

 Find the FIRST of  :{b,a,c}
